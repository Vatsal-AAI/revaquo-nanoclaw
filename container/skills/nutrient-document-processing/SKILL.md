...
Process documents with the [Nutrient DWS Processor API](https://api.nutrient.io/build). Convert formats, extract text and tables, OCR scanned documents, redact PII, add watermarks, digitally sign, and fill PDF forms.

## Setup

Get a free API key at **nutrient.io** and set it as an environment variable:
